...
export class Home {
  modules = [
    ...
    },
    {
      ...
      description:
        'AI-powered word-for-word translation for Sanskrit slokas with Tamil and English support.',
      route: '/sanskrit',
      icon: '📜',
      color: '#FF9933',
    },
    {
      ...
      description:
        'Refine existing translations with AI-suggested improvements and grammatical fixes.',
      route: '/corrector',
      icon: '✨',
      color: '#10B981',
    },
    {
      title: 'Books Library',
      description: 'Review your translated spiritual archives.',
      route: '/books',
      icon: '📚',
      color: '#6B7280',
    },
